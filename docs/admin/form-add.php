                  ...
                  <div class="card-body p-5 bg-light">
                    ...
                    <form action="novo_usuario.php" method="post">
                      <div class="form-group">
                        <input class="form-control" placeholder="Nome Completo" type="text" name="nome" id="nome">
                      </div>
                      <div class="form-group">
                        <input class="form-control" placeholder="Nome de usuário" type="text" name="login" id="login">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <input class="form-control" placeholder="Repita a senha" type="password" name="valida_senha" id="valida_senha">
                      </div>
